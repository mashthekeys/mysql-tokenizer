...
Elapsed Time (lower is better):
  {
    ...
    'regexp PossibleComment test': 16288,
    'functional PossibleComment test': 13961,
    'object PossibleComment test': 14103,
    'regexp PossibleComment exec': 17829,
    'functional PossibleComment exec': 19754,
    'object PossibleComment exec': 21322,
...
const functional = {
    ...
    PossibleComment: new MockRegExp(1, function (string) {
        const chr = string[0];
        return chr === '-' || chr === '#' || chr === '/';
    }),
...
const PossibleCommentObject = { '-': true, '#': true, '/': true };
...
const object = {
    ...
    PossibleComment: new MockRegExp(1, function (string) {
        return PossibleCommentObject[string[0]];
    }),
    Quote: new MockRegExp(1, function (string) {
